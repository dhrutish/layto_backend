...
@section('content')
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table-responsive" id="table_states"
    ...
    <div class="modal fade" id="statemodal" tabindex="-1" data-bs-backdrop="static"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="needs-validation" novalidate="" method="post" data-next="{{ route('states.store') }}"
                    id="stateform">
...
@endsection
@section('scripts')
    <script src="{{ url('resources/views/admin/states/states.js') }}"></script>
@endsection
