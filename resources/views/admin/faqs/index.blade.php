...
@section('content')
    ...
    <div class="modal fade" id="faqmodal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="faqmodalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="faqmodalLabel" data-edit-title="{{ trans('labels.edit') }}" data-add-title="{{ trans('labels.create') }}"></h5>
                    <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form class="needs-validation" novalidate="" method="post" data-next="{{ route('faqs.store') }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="description" class="form-label required">{{ trans('labels.description') }}</label>
                                    <textarea class="form-control" name="description" id="description" placeholder="{{ trans('labels.description') }}" rows="8"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
@endsection
@section('scripts')
    <script src="{{ url('resources/views/admin/faqs/faqs.js') }}"></script>
