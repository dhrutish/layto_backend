...
@section('content')
    ...
    <div class="modal fade" id="availabilitiesmodal" tabindex="-1" data-bs-backdrop="static"
        aria-labelledby="availabilitiesmodalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="availabilitiesmodalLabel"
                        data-edit-title="{{ trans('labels.edit') }}"
                        data-add-title="{{ trans('labels.create') }}"></h5>
                    <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form class="needs-validation" novalidate="" method="post" data-next="{{ route('availabilities.store') }}"
                    id="availabilitiesform">
                    <div class="modal-body">
                        @csrf
                        <input type="hidden" name="availabilitiesid" id="availabilitiesid">
                        <div class="row">
                            <div class="col-md-12">
...
@endsection
@section('scripts')
    <script src="{{ url('resources/views/admin/availabilities/availabilities.js') }}"></script>
@endsection
