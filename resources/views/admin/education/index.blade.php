...
@section('content')
    ...
    <div class="modal fade" id="educationmodal" tabindex="-1" data-bs-backdrop="static"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="needs-validation" novalidate="" method="post" data-next="{{ route('education.store') }}"
                    id="educationform">
...
@endsection
@section('scripts')
    <script src="{{ url('resources/views/admin/education/education.js') }}"></script>
@endsection
