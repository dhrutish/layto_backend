...
@section('content')
    <div class="content">
        ...
        <div class="card">
            <div class="card-body">
                <table class="table-responsive" id="table_salarytypes"
    ...
    <div class="modal fade" id="salarytypesmodal" tabindex="-1" data-bs-backdrop="static"
        aria-labelledby="salarytypesmodalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="salarytypesmodalLabel"
                        data-edit-title="{{ trans('labels.edit') }}"
                        data-add-title="{{ trans('labels.create') }}"></h5>
                    <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form class="needs-validation" novalidate="" method="post" data-next="{{ route('salary-types.store') }}"
                    id="salarytypesform">
                    <div class="modal-body">
                        @csrf
                        <input type="hidden" name="salarytypesid" id="salarytypesid">
                        <div class="row">
                            <div class="col-md-12">
...
@endsection
@section('scripts')
    <script src="{{ url('resources/views/admin/salarytypes/salarytypes.js') }}"></script>
@endsection --}}
