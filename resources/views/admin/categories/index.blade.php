...
@section('content')
    <div class="content">
        ...
        <div class="card">
            <div class="card-body">
                <table class="table-responsive" id="table_categories" data-url="{{ request()->url() }}" data-toggle="table"
    ...
    <div class="modal fade" id="categoriesmodal" tabindex="-1" data-bs-backdrop="static"
        aria-labelledby="categoriesmodalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="categoriesmodalLabel" data-edit-title="{{ trans('labels.edit') }}"
                        data-add-title="{{ trans('labels.create') }}"></h5>
                    <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form class="needs-validation" novalidate="" method="post" data-next="{{ route('categories.store') }}"
                id="categoriesform">
...
@endsection
@section('scripts')
    <script src="{{ url('resources/views/admin/categories/categories.js') }}"></script>
@endsection
