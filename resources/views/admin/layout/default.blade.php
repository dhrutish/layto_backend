...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180"
        href="{{ asset('storage/app/public/admin/assets/img/favicons/apple-touch-icon.png') }}" />
    <link rel="icon" type="image/png" sizes="32x32"
        href="{{ asset('storage/app/public/admin/assets/img/favicons/favicon-32x32.png') }}" />
    <link rel="icon" type="image/png" sizes="16x16"
        href="{{ asset('storage/app/public/admin/assets/img/favicons/favicon-16x16.png') }}" />
    <link rel="shortcut icon" type="image/x-icon"
        href="{{ asset('storage/app/public/admin/assets/img/favicons/favicon.ico') }}" />
    ...
    <link href="https://fonts.googleapis.com/css2?family=Nunito+Sans:wght@300;400;600;700;800;900&amp;display=swap"
        rel="stylesheet" />
    <link rel="stylesheet" href="{{ asset('storage/app/public/admin/vendors/simplebar/simplebar.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('storage/app/public/admin/vendors/fontawesome/all.min.css') }}" />
    ...
    <link rel="stylesheet" href="{{ asset('storage/app/public/admin/vendors/bootstrap-table/bootstrap-table.min.css') }}">
    @yield('styles')
    <link type="text/css" rel="stylesheet" href="{{ asset('storage/app/public/admin/assets/css/custom.css') }}">
    <link type="text/css" rel="stylesheet" href="{{ asset('storage/app/public/admin/assets/css/sweetalert2.min.css') }}">
...
<body class="">
    ...
    <main class="main" id="top">
        ...
        {{-- <div class="support-chat-container">
                ...
                <div class="card bg-white">
                    <div class="card-header d-flex flex-between-center px-4 py-3 border-bottom">
                        <h5 class="mb-0 d-flex align-items-center gap-2">
                            Demo widget<span class="fa-solid fa-circle text-success fs--3"></span>
                        </h5>
                        <div class="btn-reveal-trigger">
                            ...
                            <div class="dropdown-menu dropdown-menu-end py-2" aria-labelledby="support-chat-dropdown">
                                <a class="dropdown-item" href="javascript:void(0)#!">Request a callback</a><a
                                    class="dropdown-item" href="javascript:void(0)#!">Search in chat</a><a class="dropdown-item"
                                    href="javascript:void(0)#!">Show history</a><a class="dropdown-item" href="javascript:void(0)#!">Report
                                    to Admin</a><a class="dropdown-item btn-support-chat" href="javascript:void(0)#!">Close
                                    Support</a>
                            </div>
                        </div>
                    </div>
            ...
            <button class="btn p-0 border border-200 btn-support-chat">
                <span class="fs-0 btn-text text-primary text-nowrap">Chat demo</span><span
                    class="fa-solid fa-circle text-success fs--1 ms-2"></span><span
                    class="fa-solid fa-chevron-down text-primary fs-1"></span>
            </button>
        </div> --}}
    </main>
    ...
    {{-- <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1"
        ...
        <div class="offcanvas-header align-items-start border-bottom flex-column">
            ...
            <button class="btn btn-layto-secondary w-100" data-theme-control="reset">
        ...
        <div class="offcanvas-body scrollbar px-card" id="themeController">
            ...
            <a class="bun btn-primary d-grid mb-3 text-white dark__text-100 mt-5 btn btn-primary"
                href="https://themes.getbootstrap.com/product/layto-admin-dashboard-webapp-template/"
                target="_blank">Purchase
                template</a>
        </div>
    </div>
    <a class="card setting-toggle" href="javascript:void(0)#settings-offcanvas" data-bs-toggle="offcanvas">
    ...
    <script src="{{ asset('storage/app/public/admin/vendors/echarts/echarts.min.js') }}"></script>
    ...
    <script src="{{ asset('storage/app/public/admin/vendors/bootstrap-table/bootstrap-table.min.js') }}"></script>
    <script src="{{ asset('storage/app/public/admin/vendors/bootstrap-table/extensions/export/bootstrap-table-export.js') }}"></script>
    ...
    <script src="{{ asset('storage/app/public/admin/assets/js/crm-dashboard.js') }}"></script>
    ...
    <script>
        ...
        let bs_spinner = '<div class="text-center"><div class="spinner-border spinner-border-sm" role="status"><span class="visually-hidden">Loading...</span></div></div>';

        let plus_svg_icon = '<i class="fa-regular fa-plus"></i>';
