...
@section('content')
    <div class="content">
        ...
        <div class="card">
            <div class="card-body">
                <table class="table-responsive" id="table_jobtypes"
    ...
    <div class="modal fade" id="jobtypesmodal" tabindex="-1" data-bs-backdrop="static"
        aria-labelledby="jobtypesmodalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="jobtypesmodalLabel"
                        data-edit-title="{{ trans('labels.edit') }}"
                        data-add-title="{{ trans('labels.create') }}"></h5>
                    <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form class="needs-validation" novalidate="" method="post" data-next="{{ route('job-types.store') }}"
                    id="jobtypesform">
                    <div class="modal-body">
                        @csrf
                        <input type="hidden" name="jobtypesid" id="jobtypesid">
                        <div class="row">
                            <div class="col-md-12">
...
@endsection
@section('scripts')
    <script src="{{ url('resources/views/admin/jobtypes/jobtypes.js') }}"></script>
@endsection
