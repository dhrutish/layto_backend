...
<body>
    <div
        ...
        <div class="email-body">
            ...
            <p style="text-align:center; ">Thank you for signing up with us. Please use the following One-Time Password (OTP) to verify your account:</p>

            <p style="color:#455056; font-size:18px;line-height:20px; margin:0; font-weight: 500;text-align:center;">
                <strong style="display: block; font-size: 13px; margin: 24px 0 4px 0; font-weight:normal; color:rgba(0,0,0,.64);">Here is the temporary OTP.</strong>
                {{ $otp }}
            </p>
