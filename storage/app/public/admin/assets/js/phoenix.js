(function (global, factory) {
    ...
    const toggleColor = (e, t) =>
        "light" === window.config.config.phoenixTheme ? e : t;
    ...
    const getColor = (e, t = document.documentElement) =>
        getComputedStyle(t).getPropertyValue(`--layto-${e}`).trim();
    ...
    const echartSetOption = (e, t, a, r) => {
        const { breakpoints: o, resize: s } = window.phoenix.utils,
            n = (t) => {
            ...
            c = document.body;
        e.setOption(merge$2(a(), t)),
            s(() => {
                e.resize(), r && n(r);
            }),
            r && n(r),
            c.addEventListener("clickControl", ({ detail: { control: r } }) => {
        ...
        if (o) {
            ...
            echartSetOption(l, n, () => ({
                ...
                xAxis: {
                    ...
                    axisLine: { lineStyle: { color: t("gray-200") } },
                    axisTick: !1,
                },
                yAxis: {
                    type: "value",
                ...
                series: [
                    {
                        ...
                        label: { show: !1 },
                        itemStyle: { color: e(t("primary-300"), t("primary")) },
                        data: i,
                    },
                ],
                grid: {
    ...
    const chatInit = () => {
        ...
        d.forEach((e) => {
            e.addEventListener("click", () => {
                if (
                    (s.classList.remove("show"), e.classList.contains("unread"))
                ) {
                    ...
                    t.forEach((t) => {
                        ...
                        d.on("updated", (e) => {
                            const a =
                                ...
                                document.getElementById(i.fallback);
                            a &&
                        ...
                        const p = () => {
                            c &&
                                (c.innerHTML = `${d.i} to ${b} <span class='text-600'> Items of </span>${g}`),
                                l && togglePaginationButtonDisable(l, 1 === v),
                                n && togglePaginationButtonDisable(n, v === m),
                                v > 1 &&
                                    v < m &&
                                ...
                                t
                                    ...
                                    .addEventListener("click", (e) => {
                                        "page" === e.target.classList[0] &&
                                            ((v = Number(e.target.innerText)),
                                            p());
                                    }),
                            i.filter)
                        ) {
                            const { key: e } = i.filter;
    ...
    const modalInit = () => {
        const o = document.querySelectorAll("[data-layto-modal]");
        o &&
            o.forEach((o) => {
    ...
    const handleNavbarVerticalCollapsed = () => {
        const {
            ...
            s = ".navbar-vertical .nav-link.active",
            c = "click",
            n = "mouseover",
            v = "mouseleave",
            i = "navbar.vertical.toggle",
            d = "navbar-vertical-collapsed",
            u = "navbar-vertical-collapsed-hover",
            b = document.querySelector(r),
            m = document.querySelector(l),
            p = document.querySelector(o),
            h = document.querySelector(s),
            g = e("phoenixIsNavbarVerticalCollapsed", !1);
        b &&
            b.addEventListener(c, (e) => {
                b.blur(),
                    m?.classList.toggle(d),
                    t("phoenixIsNavbarVerticalCollapsed", !g);
                const a = new CustomEvent(i);
                e.currentTarget?.dispatchEvent(a);
            }),
            p &&
                (p.addEventListener(n, () => {
                    a(m, d) && m?.classList.add(u);
                }),
                p.addEventListener(v, () => {
                    a(m, u) && m?.classList.remove(u);
                }),
                h && !g && h.scrollIntoView({ behavior: "smooth" }));
    };

    const phoenixOffcanvasInit = () => {
        const { getData: e } = window.phoenix.utils,
            o = document.querySelectorAll("[data-layto-toggle='offcanvas']"),
            t = document.querySelector("[data-layto-backdrop]"),
            n = (e) => {
        ...
        o &&
            o.forEach((o) => {
                const a = e(o, "layto-target"),
                    c = document.querySelector(a),
                    d = c.querySelector("[data-layto-dismiss='offcanvas']");
                o.addEventListener("click", () => {
    ...
    const randomColorInit = () => {
        ...
        t.forEach((t) => {
            const r = o(t, "random-color");
            let a;
            (a = Array.isArray(r) ? [...F, ...r] : [...F]),
                t.addEventListener("click", (o) => {
                    const t = a[Math.floor(Math.random() * (a.length - 1))];
                    o.target.value = t;
                });
        });
    };
    ...
    const sortableInit = () => {
        // const a = document.querySelectorAll("[data-sortable]"),
        //     t = document.querySelector("[data-kanban-container]");
        // t &&
        //     t.addEventListener("click", (a) => {
        //         a.target.hasAttribute("data-kanban-collapse") &&
        //             a.target
        //                 .closest(".kanban-column")
        //                 .classList.toggle("collapsed");
        //     }),
        //     a.forEach((a) =>
        //         window.Sortable.create(a, {
        //             animation: 150,
        //             group: { name: "shared" },
        //             delay: 100,
        //             delayOnTouchOnly: !0,
            ...
            initialDomSetup(o.node),
                o.on("click", (e) => {
                    ...
                    if (n.data("theme-control")) {
                        ...
                        let l =
                            e.target[
                                "radio" === e.target.type ? "value" : "checked"
                            ];
                        switch (
                            ("phoenixTheme" === i &&
                                "boolean" == typeof l &&
                                (l = l ? "dark" : "light"),
                            config.hasOwnProperty(i) &&
                                window.config.set({ [i]: l }),
    ...
    const wizardInit = () => {
        const { getData: e } = window.phoenix.utils,
            ...
            a = "theme-wizard-progress",
            n = "submit",
            s = "show.bs.tab",
            r = "shown.bs.tab",
            d = "click";
        document.querySelectorAll(t.WIZARDS).forEach((l) => {
            const o = l.querySelectorAll(t.TOGGLE_BUTTON_EL),
                i = l.querySelectorAll(t.FORMS),
                c = l.querySelector(t.passwordInput),
                u = l.querySelector(t.CONFIRM_PASSWORD_INPUT),
                w = l.querySelector(t.NEXT_BTN),
                h = l.querySelector(t.PREV_BTN),
                E = l.querySelector(t.FOOTER),
                T = new Event(n, { bubbles: !0, cancelable: !0 }),
                L = l.querySelector(t.KANBAN_STEP),
                S = l.classList.contains(a),
                b = Array.from(o).map((e) =>
            ...
            i.forEach((e) => {
                e.addEventListener(
                    ...
                    (t) => (
                        ...
                        (c &&
                            u &&
                            (c.value !== u.value
                                ? u.setCustomValidity("Invalid field.")
                                : u.setCustomValidity("")),
                        !e.checkValidity())
                            ? (p.preventDefault(), !1)
                            : ((m += 1), null)
                ...
                w.addEventListener(d, () => {
                    m + 1 < b.length && b[m + 1].show(),
                        L && (L.innerHTML = `${m + 1}/${b.length}`);
                }),
                ...
                o.length &&
                    o.forEach((t, a) => {
                        t.addEventListener(s, (a) => {
                            const n = e(t, "wizard-step");
                            (p = a), n > m && i[m].dispatchEvent(T);
                        }),
                            t.addEventListener(r, () => {
                                ...
                                for (let e = 0; e < m; e += 1)
                                    o[e].classList.add("done"),
                                        e > 0 &&
                                            o[e - 1].classList.add("complete");
                                for (let e = m; e < o.length; e += 1)
                                    o[e].classList.remove("done"),
                                        e > 0 &&
                                            o[e - 1].classList.remove(
                                                "complete"
                                            );
                                m > o.length - 2 &&
                                    S &&
