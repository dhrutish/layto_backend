(function (factory) {
    ...
    const contactsBySourceChartInit = () => {
        const { getColor: e, getData: t } = window.phoenix.utils,
            ...
            r =
                a != "" && a != null
                    ? a.querySelector(".echart-contact-by-source")
                    : "",
            o = a != "" && a != null ? a.querySelector("[data-label]") : "";
        if (r) {
            const a = t(r, "echarts"),
                ...
                () => ({
                    ...
                    xAxis: {
                        ...
                        axisLabel: {
                            color: t("gray-800"),
                            formatter: (t) =>
                                window.dayjs(t).format("D MMM, YY"),
    ...
    const addClicksChartInit = () => {
        const {
            ...
            i = document.querySelector(".echart-add-clicks-chart"),
            r = e(11),
            n = [
    ...
    const echartsLeadConversiontInit = () => {
        const {
            ...
            i = document.querySelector(".echart-lead-conversion"),
            t = r(4);
        if (i) {
            const r = o(i, "echarts"),
                a = echarts.init(i);
    ...
    const echartsRevenueTargetInit = () => {
        const { getColor: e, getData: a } = window.phoenix.utils,
            t = document.querySelector(".echart-revenue-target-conversion"),
            r = [42e3, 35e3, 35e3, 4e4],
